...
@ToString
@AllArgsConstructor
public class FindUrlBlogRequestDto {

    @NotBlank(message = "블로그 url이 누락되었습니다.") // 카카오, 네이버 API 공백 시 에러로 인해 필수 값
    private String url;
    ...
    public FindUrlBlogRequestDto checkForgery() throws CustomException {
